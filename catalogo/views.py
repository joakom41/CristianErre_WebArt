...
def lista_obras(request):
    ...
    # -----------------------------------------------------------
    # 3. FILTRO 2: Lógica de Filtrado por Artista (Parámetro 'artista')
    # Uso request.GET para obtener el ID del Artista (ej: ?artista=1)
    # -----------------------------------------------------------
    ...
    # 5. Paginación (Necesario para la vista del catálogo)
